...
.mytable{border-top:#000000 1px solid;border-left:#000000 1px solid;line-height:22px;BORDER-COLLAPSE: collapse;width:645px;margin:0 auto}
...
.uphoto2{width:120px;height:150px;}
@media print { 
...
<h4>公开招聘报名登记表</h4>
  <table border="0" align="center" cellpadding="0" cellspacing="0" class="mytable">
    ...
    <tr>
      ...
      <td align="center"><div class="uzzcontent" style="height:20px;width:90px"><%=jg%></div></td>
	...
	<tr>
      <td colspan="2" align="center" bgcolor="#F7F7F7">现从事专业及年限</td>
	...
	<table border="0" align="center" cellpadding="0" cellspacing="0" class="mytable" style="margin-top:75px">
	<tr>
    ...
    <tr>
      <td align="center" bgcolor="#F7F7F7" style="height:250px">家庭<br />
        成员<br />
        及主<br />
        要社<br />
        会关<br />
    ...
    <tr>
      <td align="center" valign="middle" bgcolor="#F7F7F7" style="height:200px;">所在<br />
        单位<br />
      初审<br />
      意见</td>
