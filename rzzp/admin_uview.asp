...
%>
  <table width="500" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#F2F2F2" style="line-height:30px;">
    ...
    <tr>
      <td width="20%" align="right" bgcolor="#F2FDDB">真实姓名：</td>
      <td bgcolor="#FFFFFF"><%=rs("uname")%></td>
    </tr>
    <tr>
      <td align="right" bgcolor="#F2FDDB">工作单位：</td>
      <td bgcolor="#FFFFFF"><%=rs("dname")%></td>
    </tr>
    <tr>
      <td align="right" bgcolor="#F2FDDB">身份证号码：</td>
      <td bgcolor="#FFFFFF"><%=rs("card")%></td>
    </tr>
    <tr>
      <td align="right" bgcolor="#F2FDDB">出生年月：</td>
      <td bgcolor="#FFFFFF"><%=rs("birthday")%></td>
    </tr>
    <tr>
      <td align="right" bgcolor="#F2FDDB">性 别：</td>
      <td bgcolor="#FFFFFF"><%=rs("sex")%></td>
    </tr>
    <tr>
      <td align="right" bgcolor="#F2FDDB">民 族：</td>
      <td bgcolor="#FFFFFF"><%=rs("mz")%></td>
    </tr>
    <tr>
      <td align="right" bgcolor="#F2FDDB">婚姻状况：</td>
      <td bgcolor="#FFFFFF"><%=rs("hy")%></td>
    </tr>
    <tr>
      <td align="right" bgcolor="#F2FDDB">籍贯：</td>
      <td bgcolor="#FFFFFF"><%=rs("jg")%></td>
    </tr>
    <tr>
      <td align="right" bgcolor="#F2FDDB">出生地：</td>
      <td bgcolor="#FFFFFF"><%=rs("hj")%></td>
    </tr>
    <tr>
      <td align="right" bgcolor="#F2FDDB">固定电话：</td>
      <td bgcolor="#FFFFFF"><%=rs("tel")%></td>
    </tr>
    <tr>
      <td align="right" bgcolor="#F2FDDB">手机号码：</td>
      <td bgcolor="#FFFFFF"><%=rs("mb")%></td>
    </tr>
    <tr>
      <td align="right" bgcolor="#F2FDDB">E-Mail：</td>
      <td bgcolor="#FFFFFF"><%=rs("email")%></td>
    </tr>
    <tr>
      <td align="right" bgcolor="#F2FDDB">身体状况：</td>
