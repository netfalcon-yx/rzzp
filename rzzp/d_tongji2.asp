...
%>
<body>
<div class="Noprint"><h3 style="text-align:center">请使用横向打印 【打印】</h3></div>
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#333333" class="printtable">
  ...
  %>
  <tr>
    <td colspan="18" align="center" bgcolor="#FFFFFF">备注：各单位人事部门对报名的人员均进行统计，不得遗漏（电子报名表均上报），并写明初审结果，初审通过的，带相关材料进行复审。</td>
  </tr>
</table>
</body>
</html>
