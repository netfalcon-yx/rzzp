...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="mytable" id="tbulist">
  ...
  <tr>
    ...
    <td align="center"><a href="admin_u_del.asp?uid=<%=rs("uid")%>" onClick="{if(confirm('警告：确定删除该用户吗?删除此用户将同时删除用户的报名及考试信息！')){return true;}return false;}">删除</a></td>
  </tr>
  <%
  	i=i+1
	rs.movenext
  ...
  %>
  <tr>
    <td colspan="9" align="center"><%mypage.showpage()%></td>
  </tr>
</table>
<% 
rs.close
