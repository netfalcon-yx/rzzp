...
<body>
<div class="unav">
	<span style="float:right;margin-right:10px"><strong>>><a href="admin_job_tongji.asp?jid=<%=jid%>">切换为按单位统计</a></strong></span>
    ...
    &nbsp;&nbsp;<a href="admin_tj_gwsum.asp?jid=<%=jid%>">返回岗位报名合计</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" onclick="getTblData('gwtable')">导出Excel</a>&nbsp;&nbsp;
    </form>
</div>
